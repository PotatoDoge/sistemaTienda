...
class DeleteProduct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val deleteProd = findViewById<Button>(R.id.borrarProducto)
        ...
        deleteProd.setOnClickListener {
            if(checkIfFieldsEmpty(prod,descProd,nombrProd)){
                throwAlertDelete("¿Seguro?","¿Está seguro que quiere borrar este producto?")
            }
        }
    }
    ...
    private fun borrarProducto(){
        deleteProductInDatabase(prod.text.toString(), "http://charlyffs.mywire.org:9000/borrar_producto.php")
